...
* Gibbs sampling is by definition sequential. Every choice of z depends on all the other z (TODO: what is z here?). We need to modify the algorithm and try approximate distributed LDA.
